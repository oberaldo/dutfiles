...
while read -r line ; do
  ...
  # And finally, output
#  printf "%s\n" "%{l}${wsp}${title} %{r}${mpd}${stab}${irc}${stab}${mem}${stab}${cpu}${stab}${gmail}${stab}${vol}${stab}${date}${stab}${time}"
  #printf "%s\n" "%{l}${wsp}${title}"
#done

printf "%s\n" "%{l}${wsp}${title}%{r}${mpd}${irc}${stab}${stab}${wea}${stab}${gmail}${stab}${cpu}${stab}${mem}${stab}${diskr}${stab}${vol}${stab}${date}${stab}${time}"
done