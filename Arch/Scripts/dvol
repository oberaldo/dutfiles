...
SECS="3"            # sleep $SECS
BG="#03070B"        # background colour of window
FG="#ffffff"        # foreground colour of text/icon
BAR_FG="#4B1A2C"    # foreground colour of volume bar
BAR_BG="#14161A"    # background colour of volume bar
SCR_HEIGHT="100"   # screen height
SCR_WIDTH="2280"    # screen width
HEIGHT="30"         # window height
WIDTH="250"         # window width
BAR_WIDTH="165"     # width of volume bar
SOUND_ICON=~/.icons/xbm8x8/spkr_01.xbm
MUTE_ICON=~/.icons/xbm8x8/spkr_01.xbm
